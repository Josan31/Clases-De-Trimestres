...
# En matemáticas, también significa aplicar una función repetidamente usando el resultado anterior como entrada.

# ¿QUÉ ES WHILE?
# Es una estructura de control que ejecuta un bloque de código mientras una condición lógica sea verdadera.
# Cuando termina una vuelta, vuelve a comprobar la condición. Si es falsa desde el inicio, no se ejecuta nada.

# ¿QUÉ HACE WHILE TRUE?
# Crea un bucle infinito, ya que la condición siempre es verdadera.
# Es útil cuando no sabemos cuántas veces se repetirá el ciclo.
# Para salir, se usa la instrucción 'break', que lo detiene inmediatamente
